...
```
3. [目标和](https://leetcode.cn/problems/target-sum/description/)
问题描述：  
...
#### 背包变形（求方案数）
1. [零钱兑换||](https://leetcode.cn/problems/coin-change-2/)
问题描述：  
...
```
2. [组合总和Ⅳ](https://leetcode.cn/problems/combination-sum-iv/)
问题描述：
...
#### 背包变形（缺少物品的价值）
1. [小哥派件装载问题](https://leetcode.cn/contest/sf-tech/problems/cINqyA/)
问题描述：  
